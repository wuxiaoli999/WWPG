...
public class PoiUtilTop {
	...
	public XSSFWorkbook createHssf(String title,List<List> data,int[] width,int[] style) {	    
		...
		try{
		    ...
		    int len = data.get(2).size();
		    addRow(row, headStyle, len);
		    row.getCell((short)0).setCellValue((String)vtrCaption.get(0));
		    row.getCell((short)1).setCellValue((String)vtrCaption.get(1));
		    row.getCell((short)2).setCellValue((String)vtrCaption.get(2));
		    row.getCell((short)3).setCellValue((String)vtrCaption.get(3));		
		    row.getCell((short)7).setCellValue((String)vtrCaption.get(4));
		    row.getCell((short)9).setCellValue((String)vtrCaption.get(5));	
		   
		    sheet.addMergedRegion(new CellRangeAddress(2, (short)3, 2, (short)4));
		    
		    sheet.addMergedRegion(new CellRangeAddress(2, (short)6, 2, (short)8));
		    
		    row = sheet.createRow(iRow++);
		    Vector vtrCaption1 = new Vector(data.get(1));	   
		    addRow(row, headStyle, vtrCaption1);	
		    
		    sheet.addMergedRegion(new CellRangeAddress(2, (short)0, 3, (short)0));
		    sheet.addMergedRegion(new CellRangeAddress(2, (short)1, 3, (short)1));
		    sheet.addMergedRegion(new CellRangeAddress(2, (short)2, 3, (short)2));
	...
	private void addRow(XSSFRow row, XSSFCellStyle hStyle, int len) {
	    for(int i=0;i<len;i++){
	      XSSFCell cell = row.createCell((short)i);
